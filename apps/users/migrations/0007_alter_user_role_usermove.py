...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('apps_user', '0006_remove_user_username_alter_user_role'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_move', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
